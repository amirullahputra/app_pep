...
import { PHASES, COMPOUNDS, SP } from './data.js?v=39';
import { S, rpM, initBudSel, QUARTERS, quarterLabel, quarterDateRange,
  quarterFromWeek, weeksInQuarter, costForQuarter, quarterCost, tlCostForQuarter } from './state.js?v=39';
import * as stateModule from './state.js?v=39';
import { DM, syncDMStages, buildDefaultSeed } from './state.js?v=39';
import {
