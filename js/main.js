...
import { PHASES, COMPOUNDS, SP } from './data.js?v=55';
import { S, rpM, initBudSel, QUARTERS, quarterLabel, quarterDateRange,
  quarterFromWeek, weeksInQuarter, costForQuarter, quarterCost, tlCostForQuarter } from './state.js?v=55';
import * as stateModule from './state.js?v=55';
import { DM, syncDMStages, buildDefaultSeed } from './state.js?v=55';
import {
...
import * as panelFns from './panels.js?v=55';
import * as supaFns from './supabase.js?v=55';
