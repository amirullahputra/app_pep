...
import { PHASES, COMPOUNDS, SP } from './data.js?v=83';
import { S, rpM, initBudSel, QUARTERS, quarterLabel, quarterDateRange,
  quarterFromWeek, weeksInQuarter, costForQuarter, quarterCost, tlCostForQuarter } from './state.js?v=83';
import * as stateModule from './state.js?v=83';
import { DM, syncDMStages, buildDefaultSeed } from './state.js?v=83';
import {
...
import * as panelFns from './panels.js?v=83';
import * as supaFns from './supabase.js?v=83';
