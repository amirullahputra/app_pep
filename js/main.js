...
import { PHASES, COMPOUNDS, SP } from './data.js?v=85';
import { S, rpM, initBudSel, QUARTERS, quarterLabel, quarterDateRange,
  quarterFromWeek, weeksInQuarter, costForQuarter, quarterCost, tlCostForQuarter } from './state.js?v=85';
import * as stateModule from './state.js?v=85';
import { DM, syncDMStages, buildDefaultSeed } from './state.js?v=85';
import {
...
import * as panelFns from './panels.js?v=85';
import * as supaFns from './supabase.js?v=85';
...
function setQuarter(qid){
  ...
  S.budSel = new Set();  // reset checkbox state saat quarter ganti
