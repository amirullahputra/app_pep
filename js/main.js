...
import { PHASES, COMPOUNDS, SP } from './data.js?v=70';
import { S, rpM, initBudSel, QUARTERS, quarterLabel, quarterDateRange,
  quarterFromWeek, weeksInQuarter, costForQuarter, quarterCost, tlCostForQuarter } from './state.js?v=70';
import * as stateModule from './state.js?v=70';
import { DM, syncDMStages, buildDefaultSeed } from './state.js?v=70';
import {
...
import * as panelFns from './panels.js?v=70';
import * as supaFns from './supabase.js?v=70';
